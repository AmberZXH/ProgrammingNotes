...
**<font color=red>如果定义的变量准备在将来用于保存对象，那么最好将该变量的初始值设为 null 而不是其他值。</font>**
